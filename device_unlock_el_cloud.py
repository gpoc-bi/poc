...
def process_fact_device_unlock(df, df_cust, df_rsn, columns):
    ...
    print("fact data after first  join")
    print(output.show())
    ...
    print("fact data after two  joins")    
    print(output1.show())
...
def main():
    ...
    try:
      ...
      device_unlock_config = {"last_processed": "20200422", "max_status_rsn_id": 1, "max_cust_id": 1}
      print("hello")
    except:
        e = sys.exc_info()[0]
       # log.error(e)
    ...
    # last processed date
    last_processed_date = datetime.datetime.strptime('20200422', '%Y%m%d').date()
